...
def imshow_gt_det_bboxes(img,
    ...
    Args:
      ...
      result (dict): The detection result where contain keys of 'bbox_results' and
          'bbox_labels'
      class_names (list[str]): Names of each classes.
      score_thr (float): Minimum score of bboxes to be shown.  Default: 0
    ...
    bboxes = result['bbox_results']
    labels = result['bbox_labels']
    segm_result = result.get('segm_result', None)
